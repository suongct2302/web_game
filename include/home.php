	...
	<div class="ads-grid py-sm-5 py-4">
		<div class="container py-xl-4 py-lg-2">
			...
			<h3 class="tittle-w3l text-center mb-lg-5 mb-sm-4 mb-3">
				<h3 class="tittle-w3l text-center mb-lg-5 mb-sm-4 mb-3">Danh mục Tin Tức</h3>
			<!-- //tittle heading -->
			<div class="row">
				<!-- product left -->
										...
										<div class="men-thumb-item text-center">
											...
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="?quanly=chitietsp&id=<?php echo $row_sanpham['sanpham_id'] ?>" class="link-product-add-cart">Xem tin</a>
												</div>
											</div>
										</div>
				...
				<div class="col-lg-3 mt-lg-0 mt-4 p-lg-0">
					<div class="side-bar p-sm-4 p-3">
						...
						<div class="left-side border-bottom py-2">
							...
							<h3 class="agileits-sear-head mb-3">Danh mục tin</h3>
							<ul>
								<?php 
						...
						<div class="f-grid py-2">
							<h3 class="agileits-sear-head mb-3">Game được yêu thích nhất</h3>
